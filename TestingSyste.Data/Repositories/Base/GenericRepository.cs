namespace TestingSystem.Data.Repositories.Base
{
    using System;
    ...
    using TestingSystem.Common.Extensions;

    public class GenericRepository<T> : IRepository<T> where T : class
    {
        public GenericRepository(TestingSystemDbContext context)
        {
            if (context == null)
            {
        ...
        protected TestingSystemDbContext Context { get; set; }
